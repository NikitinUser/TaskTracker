...
class CreatePermissionsForRoleTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('permissions_for_role', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('permissions_for_role');
    }
}
